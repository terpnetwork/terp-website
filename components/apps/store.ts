...
export const useStore = create<State>((set: (arg0: { networkConfig?: NetworkConfig; wallet?: DirectSecp256k1HdWallet; senderAddr?: string; wasmClient?: SigningCosmWasmClient; badgeCount?: any; badges?: {}; }) => void) => ({
  badges: {},
